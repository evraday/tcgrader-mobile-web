      ...
      <div className="fixed top-0 left-0 right-0 z-50 bg-white dark:bg-gray-800 border-b border-gray-100 dark:border-gray-700 safe-area-top">
        <div className="max-w-md mx-auto px-5 py-3">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center space-x-3 bg-gray-50 dark:bg-gray-700 rounded-full pl-3 pr-1 py-1">
              <div>
      ...
      <div className="max-w-md mx-auto px-5 py-6 pb-8 pt-24">
        ...
        <div className="bg-white dark:bg-gray-800 rounded-2xl p-6 shadow-sm mb-6">
          <div className="flex flex-col items-center">
            ...
            <h2 className="text-xl font-bold text-gray-900 dark:text-gray-100 mb-1">{user.username || user.name}</h2>
        ...
        <div className="grid grid-cols-2 gap-4 mb-6">
          <Link to="/collection" className="bg-white dark:bg-gray-800 rounded-2xl p-4 shadow-sm hover:shadow-md transition-shadow cursor-pointer">
            ...
            {cardStats.avgGrade > 0 && (
              <p className="text-xs text-gray-500 dark:text-gray-400 mt-1">Avg: {cardStats.avgGrade}</p>
            )}
          </Link>
          
          <Link to="/market" className="bg-white dark:bg-gray-800 rounded-2xl p-4 shadow-sm hover:shadow-md transition-shadow cursor-pointer">
            <div className="flex items-center justify-between mb-2">
        ...
        {cards.length > 0 && (
          <div className="bg-white dark:bg-gray-800 rounded-2xl p-5 shadow-sm mb-6">
            <div className="flex items-center justify-between mb-4">
              <h3 className="font-medium text-gray-900 dark:text-gray-100">Recent Cards</h3>
        ...
        {/* Quick Actions */}
        <div className="bg-white dark:bg-gray-800 rounded-2xl p-5 shadow-sm mb-6">
          <h3 className="font-medium text-gray-900 dark:text-gray-100 mb-4">Quick Actions</h3>
          <div className="grid grid-cols-2 gap-3">
            <Link to="/collection" className="group">
              <div className="bg-gray-50 dark:bg-gray-700 rounded-xl p-4 hover:bg-gray-100 dark:hover:bg-gray-600 transition-all">
                <div className="w-10 h-10 bg-primary-100 dark:bg-primary-900 rounded-lg flex items-center justify-center mb-2 group-hover:bg-primary-200 dark:group-hover:bg-primary-800 transition-colors">
            ...
            <Link to="/grades" className="group">
              <div className="bg-gray-50 dark:bg-gray-700 rounded-xl p-4 hover:bg-gray-100 dark:hover:bg-gray-600 transition-all">
                <div className="w-10 h-10 bg-accent-100 dark:bg-accent-900 rounded-lg flex items-center justify-center mb-2 group-hover:bg-accent-200 dark:group-hover:bg-accent-800 transition-colors">
        ...
        {/* Settings */}
        <div className="bg-white dark:bg-gray-800 rounded-2xl p-5 shadow-sm mb-6">
          <h3 className="font-medium text-gray-900 dark:text-gray-100 mb-4">Preferences</h3>
          ...
          <div className="space-y-2">
            <Link to="/settings/notifications" className="flex items-center justify-between p-4 bg-gray-50 dark:bg-gray-700 rounded-xl hover:bg-gray-100 dark:hover:bg-gray-600 transition-all group">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-500 dark:text-gray-400">Alerts and updates</p>
                </div>
              </div>
            ...
            <Link to="/settings/security" className="flex items-center justify-between p-4 bg-gray-50 dark:bg-gray-700 rounded-xl hover:bg-gray-100 dark:hover:bg-gray-600 transition-all group">
              <div className="flex items-center space-x-3">
            ...
            <Link to="/settings/privacy" className="flex items-center justify-between p-4 bg-gray-50 dark:bg-gray-700 rounded-xl hover:bg-gray-100 dark:hover:bg-gray-600 transition-all group">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-500 dark:text-gray-400">Data and sharing preferences</p>
                </div>
              </div>
              <svg className="w-5 h-5 text-gray-400 dark:text-gray-500 group-hover:text-gray-600 dark:group-hover:text-gray-400 transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
        ...
        {/* Support & Help */}
        <div className="bg-white dark:bg-gray-800 rounded-2xl p-5 shadow-sm mb-6">
          <h3 className="font-medium text-gray-900 dark:text-gray-100 mb-4">Support</h3>
          <div className="space-y-2">
            <Link to="/help" className="flex items-center justify-between p-4 bg-gray-50 dark:bg-gray-700 rounded-xl hover:bg-gray-100 dark:hover:bg-gray-600 transition-all group">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  <p className="font-medium text-gray-900 dark:text-gray-100">Help Center</p>
                  <p className="text-xs text-gray-500 dark:text-gray-400">FAQs and guides</p>
                </div>
              </div>
              <svg className="w-5 h-5 text-gray-400 dark:text-gray-500 group-hover:text-gray-600 dark:group-hover:text-gray-400 transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
            ...
            <Link to="/contact" className="flex items-center justify-between p-4 bg-gray-50 dark:bg-gray-700 rounded-xl hover:bg-gray-100 dark:hover:bg-gray-600 transition-all group">
              <div className="flex items-center space-x-3">
            ...
            <a href="https://tcgrader.com/terms" target="_blank" rel="noopener noreferrer" className="flex items-center justify-between p-4 bg-gray-50 dark:bg-gray-700 rounded-xl hover:bg-gray-100 dark:hover:bg-gray-600 transition-all group">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  <p className="font-medium text-gray-900 dark:text-gray-100">Terms & Conditions</p>
                  <p className="text-xs text-gray-500 dark:text-gray-400">View our terms of service</p>
                </div>
              </div>
              <svg className="w-5 h-5 text-gray-400 dark:text-gray-500 group-hover:text-gray-600 dark:group-hover:text-gray-400 transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <a href="https://tcgrader.com/privacy" target="_blank" rel="noopener noreferrer" className="flex items-center justify-between p-4 bg-gray-50 dark:bg-gray-700 rounded-xl hover:bg-gray-100 dark:hover:bg-gray-600 transition-all group">
              <div className="flex items-center space-x-3">
                <div className="w-9 h-9 bg-gray-200 dark:bg-gray-700 rounded-lg flex items-center justify-center">
                  <svg className="w-5 h-5 text-gray-600 dark:text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z" />
